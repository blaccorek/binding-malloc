/*
** mutual.c for malloc in
** /home/andriat/svn-repo/TIC-DEVC4/malloc/andria_t
**
** Made by ANDRIAMIHAMINA Tsiorintsoa
** Login   <andria_t@etna-alternance.net>
**
** Started on  Mon Feb 19 21:30:25 2018 ANDRIAMIHAMINA Tsiorintsoa
** Last update Mon Feb 26 12:26:12 2018 ANDRIAMIHAMINA Tsiorintsoa
*/
...
void		*split_free_block(t_free_block *block, size_t size)
{
  ...
  meta_left = NULL;
  if (meta->magic == F_MAGIC && meta->size % 16 == 0)
    {
      meta->magic = A_MAGIC;
      if (meta->size > size)
	{
